  ...
  "Commander": {
    ...
    talents: {
      ...
      "Ensorcelled Blow": {
        ...
        cooldown: "no cooldown",
        blue: "Sigil of Eldrazor",
        description: talentText`Deal 21% MAP + 280 elemental daage to target enemy.`,
      },
      "Cerulean Shield": {
	  ...
	  "Phoenix Wing": {
        ...
        cooldown: "no cooldown",
        blue: "Sigil of Vaul",
        description: talentText`Deals 4% MAP + 60 spiritual damage to up to 9 enemeies within 30 feet of you.\nEldrazor - Applies a 9 second affliction to each enemy hit which deals 5% SAP + 48 spiritual damage every 3 seconds.\nHoeth - Interrupts each target hit.`,
      },
	  "Blessing of Heaven": {
	  ...
	  "Hoeth's Protection": {
        name: "Hoeth's Protection",
        pos: "b5",
        icon: icons["tac_spec_6"],
        maxRank: 1,
        reqPoints: 10,
        type: "career tactic",
        description: talentText`Whenever you consume a Sigil of Hoeth, gain an enchantment for 8 seconds. For the duration, you gain 25% healing received.`,
      },
	  ...
	  "Improved Bladeworks": {
        ...
        reqPoints: 5,
        type: "passive",
        description: talentText`Heaven's Blade and Gusting Wind will deal additional damage equal to ${[
          4,
          8,
          12,
          16,
