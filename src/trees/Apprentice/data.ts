  ...
  "Swordmaster": {
    ...
    talents: {
	  ...
	  "Crashing Wave": {
        ...
        cooldown: "no cooldown",
        blue: "Sigil of Eldrazor",
        description: talentText`Deals X% MAP + Y elemental damage to up to 9 enemies within 30 feet in front of you.`,
      },
	  "Blurring Shock": {
        name: "Blurring Shock",
        pos: "a9",
        ...
        cooldown: "no cooldown",
        blue: "Sigil of Asuryan",
        description: talentText`Deals X% SAP + Y elemental damage to target enemy.\n\nEldrazor - deals X% more damage.\nHoeth - now has a 65 foot range.`,
      },
	  "Phoenix Wing": {
        name: "Phoenix Wing",
        pos: "e6",
	  ...
	  "Eagle's Protection": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`Eagle's Flight will now apply an 8 second enchantment to your defensive target. For the duration, they will absorb up to X RP% + Y damage.`,
      },
	  "Master of the Blade": {
