  ...
  "Commander": {
    ...
    talents: {
	  ...
	  "Adept Movements": {
        ...
        reqPoints: 20,
        type: "career tactic",
        description: talentText`Your absorb effects from Heaven's Blade, Cerulean Shield, and Vaul's Buffer grant you 10% dodge.`,
      },
	  "Turbulent Winds": {
    ...
    talents: {
	  ...
	  "Harmonic Dieties": {
        ...
        description: talentText`Ensorcelled Blow has a ${[
          ...
          40,
          50,
        ]}% chance to also apply Sigil of Hoeth.`,
      },
	  "Blessing of Asuryan": {
  ...
  "Loremaster": {
    ...
    talents: {
      ...
      "Potent Enchantments": {
        ...
        reqPoints: 0,
        type: "career tactic",
        description: talentText`Whenever you strike an enemy with a blade enchantment active, you will deal X% SAP + Y elemental damage every 2 seconds for 6 seconds. This effect does not refresh.`,
      },
      "Bound in Blue": {
        name: "Bound in Blue",
        pos: "d2",
