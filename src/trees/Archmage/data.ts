  ...
  "Adept of Ghyran": {
    ...
    talents: {
      ...
      "Radiant Lance": {
        ...
        cast: "2.0s cast",
        cooldown: "no cooldown",
        description: talentText`Deals 253 elemental damage to target enemy.`,
      },
      "Courage of Aenarion": {
      ...
      "Regrowth": {
        ...
        cooldown: "no cooldown",
        blue: "Lore of Life",
        description: talentText`Heal target ally for 30% RP + 411.\n\nAugmented: Apply a 12s enchantment. For the duration, target is healed for 7% RP + 116 every 3 seconds.`,
      },
      "Shield of Saphery": {
        name: "Shield of Saphery",
        pos: "e1",
        icon: icons["abi_he_shieldofsaphery"],
        maxRank: 0,
        reqPoints: 0,
        type: "spell",
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Target groupmate gains an enchantment for 8 seconds. They will absorb 20% RP + 258 damage over the duration.`,
      },
      "Cleansing Light": {
        name: "Cleansing Light",
        pos: "f1",
        icon: icons["abi_he_cleasninglight"],
        maxRank: 0,
        reqPoints: 0,
        type: "spell",
	  ...
	  "Barkskin": {
        name: "Barkskin",
        pos: "h6",
        icon: icons["item_em_tornclawspaw"],
        maxRank: 1,
        reqPoints: 15,
        type: "spell",
        cost: "30 action points",
      ...
      "Flames of the Phoenix": {
        ...
        pos: "f9",
        icon: icons["abi_he_flamespfthephoenix"],
        maxRank: 1,
        reqPoints: 30,
        type: "spell",
	  ...
	  "Nature's Splendor": {
        ...
        pos: "d6",
        icon: icons["item_he_shadowthorn"],
        maxRank: 3,
        reqPoints: 15,
        type: "passive",
