  ...
  "Battle Wizard": {
    ...
    talents: {
      ...
      "Weapon Aptitude": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Battle Wizards use staves.`,
      },
      "Melt Armor": {
        name: "Morale 1c",
        pos: "i4",
	  ...
	  "Explosive Exercise": {
        ...
        description: talentText`Whenever you deal periodic damage you have a ${[
          ...
          66,
          100,
        ]}% chance to give 1 action point to all groupmates within 100ft.`,
      },
	  ...
	  "Blinding Smoke": {
        ...
        reqPoints: 25,
        type: "passive",
        description: talentText`You have a % chance whenever you critically hit an enemy to apply one stack of Reduced Dodge to them.`,
      },
    },
  },
};
