  ...
  "Arsonist": {
    ...
    talents: {
      ...
      "Ignite": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Applies an affliction to target enemy for 15 seconds. You generate 3 Combustion and the target takes 11% SAP + 78 elemental damage every 3 seconds.\n\nCannot be applied to targets under the effect of Detonate.`,
      },
      "Detonate": {
        name: "Detonate",
        pos: "c6",
  ...
  "Pyromancer": {
    ...
    talents: {
      ...
      "Fireball": {
        ...
        cast: "3.0s cast",
        cooldown: "no cooldown",
        description: talentText`Deals 45% SAP + 225 elemental damage to target. You generate 15 Combustion.`,
      },
      "Meltdown": {
        name: "Meltdown",
        pos: "f2",
        ...
        description: talentText`Deals 19% SAP + 150 corporeal damage to the target.`,
      },
      "Flash Fire": {
        name: "Flash Fire",
        pos: "f8",
      ...
      "Sear": {
        ...
        description: talentText`Deals 19% SAP + 150 elemental damage to target and applies 2 stacks of Blast. You will take Explosion damage and gain 5 Combustion.`,
      },
      "Ignite": {
        name: "Ignite",
        pos: "c4",
      ...
      "Boiling Blood": {
        ...
        reqPoints: 25,
        type: "spell",
        cost: "40 action points no cost",
        range: "100ft range",
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Applies a cripple to the target for 5 seconds. At the end of the duration, target will take 25% SAP + 200 corporeal damage. You generate 5 Combustion`,
      },
      "Rolling Boil": {
        name: "Rolling Boil",
        pos: "g8",
      ...
      "Fireball Barrage": {
        ...
        cast: "3.0s channel",
        cooldown: "no cooldown",
        description: talentText`Deals 30% SAP + 150 elemental damage to the target and up to 2 additional enemies within 20ft of them every 1.5 seconds.`,
      },
      "Spreading Flames": {
