  ...
  "Battle Wizard": {
    ...
    talents: {
      ...
      "Weapon Aptitude": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Battle Wizards equip staves.`,
      },
      "Melt Armor": {
        name: "Morale 1c",
        pos: "i4",
      ...
      "Burning Iron": {
        ...
        description: talentText`Deals 20% SAP + 231 elemental damage to the target and applies 1 stack of Reduced Weapon Skill.`,
      },
      "Unquenchable Fury": {
        name: "Unquenchable Fury",
        pos: "e1",
      ...
      "Fiery Blast": {
        ...
        cast: "2.5s cast",
        cooldown: "no cooldown",
        description: talentText`Deals 21% SAP + 281 elemental damage to up to 9 enemies within a 30ft area you select. Generates 2 Combustion per enemy hit.`,
      },
      "Smokescreen": {
        name: "Smokescreen",
        pos: "i1",
      ...
      "Shield of Aqshy": {
        ...
        cooldown: "20s cooldown",
        blue: "Costs 40 Combustion",
        description: talentText`Applies a buff for 5s and a blessing for 10s to each groupmate within 100ft. For the buff duration, groupmate and all enemies within 20ft of them gain a stack of Blast every second. For the blessing duration, groupmate gains 1000 elemental resistance.`,
      },
      "Spreading Flames": {
        name: "Spreading Flames",
        pos: "f9",
	  ...
	  "Exquisite Firecraft": {
        ...
        type: "career tactic",
        description: talentText`Cauterize will now also dispel one blessing from the enemy. It now dispels one affliction and 2 stacks of Blast from your defensive target if they are within 100ft. No longer applies to self.`,
      },
	  "You Get Burned": {
        name: "You Get Burned",
        pos: "e8",
