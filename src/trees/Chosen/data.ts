...
export const data: TalentData = {
  ...
  "Doom Knight": {
    ...
    talents: {
	  ...
	  "Improved Tooth of Tzeentch": {
        name: "Improved Tooth of Tzeentch",
        pos: "a7",
        icon: icons["abi_ch_slash"],
        maxRank: 3,
        reqPoints: 20,
        type: "passive",
        description: talentText`Tooth of Tzeentch deals ${[
          10,
          20,
          30,
        ]}% more damage.`,
