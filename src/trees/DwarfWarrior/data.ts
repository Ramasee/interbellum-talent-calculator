  ...
  "Ironbreaker": {
    ...
    talents: {
      ...
      "Grudge Unleashed": {
        ...
        description: talentText`You generate 90 action points.`,
      },
	  "Guard": {
        name: "Guard",
        pos: "d1",
      ...
      "Binding Grudge": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 25 Grudge",
        description: talentText`Deals X% MAP + Y physical damage to target enemy and applies Ensnared and Momentum to them. Your defensive target and yourself will gain a blessing for 10 seconds. For the duration, gain 20% block chance.\n\nEnsnared reduces movement speed by 30% for 16 seconds.\nMomentum prevents the application of Ensnared for 8 seconds.`,
      },
      "Inspiring Attack": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 25 Grudge",
        description: talentText`Deals X% MAP + Y physical damage to target enemy. Your defensive target and yourself will gain 1 stack of Enhanced Ballistic Skill and a blessing for 10 seconds. For the duration, gain 10% critical chance.`,
      },
      "Away With Ye": {
        name: "Away With Ye",
        pos: "h1",
      ...
      "Runic Shield": {
        ...
        description: talentText`Your defensive target and yourself gain a blessing for 10 seconds. You will absorb damage equal to X% RP + Y for the duration.`,
      },
	  "Fire Bomb": {
        name: "Fire Bomb",
        pos: "h4",
        ...
        description: talentText`Deals X% RAP + Y corporeal damage to up to 3 enemies within a 20ft area you select.`,
      },
	  "Flashbang Grenade": {
	  ...
	  "Shield Sweep": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 40 Grudge",
        description: talentText`Deals X% MAP + Y physical damage to up to 9 enemies within 30ft in front of you.`,
      },
      "Skin of Iron": {
        name: "Skin of Iron",
        pos: "d9",
	  ...
	  "Oath of Reclamation": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`You gain Restoration Power equal to X% of your armor.`,
      },
	  "The Flashiest": {
        name: "The Flashiest",
        pos: "g6",
	  ...
	  "Ancestor Shields": {
        ...
        reqPoints: 25,
        type: "career tactic",
        description: talentText`Whenever you block an attack, you will gain 15% damage reduction for 5 seconds.`,
      },
      "Overprotective": {
        name: "Overprotective",
        pos: "e3",
	  ...
	  "Band Together": {
        ...
        description: talentText`Groupmates within 30ft of you have their damage reduction increased by ${[
          ...
          8,
          10,
        ]}%. This effect s surpressed for 5 seconds whenever you are hit by a single-target ability.`,
      },
	  "Call to Clan": {
        name: "Call to Clan",
        pos: "h8",
