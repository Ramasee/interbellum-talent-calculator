  ...
  "Rifleman": {
    ...
    talents: {
      ...
      "Signal Flare": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`Applies a cripple to target enemy that deals 11% RAP + 46 physical damage every 3 seconds over 21 seconds.`,
      },
      "Coordinated Fire": {
      ...
      "Gun Turret": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 kit",
        description: talentText`(Deployment) Summon a gun turret at your feet that will attack enemies within 125ft of it. It will give you 1 bullet every 2 seconds if you are within 30ft of it.\n\nYou can only have one Deployment skill active.`,
      },
      "Self Destruct": {
        name: "Self Destruct",
        pos: "g2",
      ...
      "Snipe": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`Deals 50% RAP + 319 physical damage to the target enemy. Applies 1 stack of Reduced Dodge.`,
      },
      "Focused Fire": {
        name: "Focused Fire",
        pos: "f9",
        ...
        description: talentText`Deals 18% RAP + 180 physical damage every second to target enemy.`,
      },
    },
  },
  "Grenadier": {
    ...
    talents: {
      ...
      "Cinderblast Bomb": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 grenade",
        description: talentText`65ft range\n1 grenade\ninstant cast\nskill\n\nApplies an affliction for 18 seconds to up to 12 enemies within a 20ft area you select. Deals 7% RAP + 57 corporeal damage every 3 seconds.`,
      },
      "Blasting Caps": {
        name: "Blasting Caps",
        pos: "d8",
