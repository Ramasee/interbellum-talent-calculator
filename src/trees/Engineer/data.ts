...
talents: {
	  ...
	  "Gun Blast": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`(Basic Attack) Deals %41 RAP + 552 piercing damage to target enemy.`,
      },
	  "Craft Munitions": {
	  ...
	  "Gun Turret": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 kit",
        description: talentText`(Deployment) Summon a gun turret at your feet that will attack enemies within 100 feet of it. It will give you 1 bullet every 2 seconds if you are within 30ft of it.\n\nYou can only have one Deployment skill active.`,
      },
	  "Signal Flare": {
        name: "Signal Flare",
        pos: "f1",
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`Applies a cripple to target enemy that deals 10% RAP + 126 ichor damage every 3 seconds over 21 seconds.`,
      },
	  "Concussion Grenade": {
	  ...
	  "Incendiary Round": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`Applies an affliction to target enemy that deals 11% RAP + 146 corporeal damage every 3 seconds over 15 seconds.`,
      },
	  ...
	  "Fire Bomb": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 grenade",
        description: talentText`Deals 11% RAP + 220 corporeal damage to up to 3 enemies within a 20 foot area you select.`,
      },
	  "Self Destruct": {
        name: "Self Destruct",
        pos: "c6",
	  ...
	  "Phosphorous Shell": {
        ...
        description: talentText`Deals 10% RAP + 110 corporeal damage to target enemy. Then it applies an affliction for 12 seconds to the target and up to 2 enemies within 20ft of them that deals 7% RAP + 91 corporeal damage every 3 seconds.`,
      },
	  "Snipe": {
        name: "Snipe",
        pos: "d9",
        ...
        cooldown: "no cooldown",
        blue: "Costs 1 bullet",
        description: talentText`Deals 68% RAP + 903 piercing damage to the target enemy. Applies 1 stack of Reduced Dodge.`,
      },
      "Focused Fire": {
        name: "Focused Fire",
        pos: "f9",
        ...
        description: talentText`Deals 30% RAP + 412 piercing damage every second to target enemy.`,
      },
	  "Hollow Points": {
        name: "Hollow Points",
        pos: "a5",
        ...
        reqPoints: 10,
        type: "career tactic",
        description: talentText`Gun Blast will now deal 8% RAP + 111 ichor damage every second for 6 seconds but the initial hit will always be blocked.`,
      },
	  "Trench Fighting": {
	  ...
	  "Controlled Demolition": {
        ...
        reqPoints: 20,
        type: "career tactic",
        description: talentText`Self Destruct no longer deploys your deployable, but costs 3 kit.`,
      },
