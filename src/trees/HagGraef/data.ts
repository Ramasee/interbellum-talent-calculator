  ...
  "Executioner": {
    ...
    talents: {
	  ...
	  "Curse of Khaine": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Applies an ailment to target enemy. At the end of the duration, deals X% RAP + Y impact damage to them. You lose 15 Animosity.\n\nAnimosity:\n0-20: 6 second duration.\n21-40: 5 second duration.\n41-60: 6 second duration.\n61-80: 8 second duration.\n81-100: 10 second duration.`,
      },
	  "Mass Execute": {
        name: "Mass Execute",
        pos: "h6",
      ...
      "Forged to Kill": {
        ...
        reqPoints: 30,
        type: "passive",
        description: talentText`Gain 150 maximum action points. Sharpened Edge now has a 5 second cooldown. Execute will now only generate 50 Animosity.`,
      },
      "Whirlwind": {
        name: "Whirlwind",
        pos: "f9",
	  ...
	  "Khaine's Imbuement": {
        ...
        reqPoints: 10,
        type: "career tactic",
        description: talentText`Fist of Khaine no longer deals direct damage. Instead it applies a 6 second ailment to target. Stacks 5 times. For the duration, target takes X% RAP + Y ichor damage every 2 seconds.`,
      },
	  "Flagellate": {
        name: "Flagellate",
        pos: "h5",
