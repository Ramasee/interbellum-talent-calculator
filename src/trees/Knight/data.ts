  ...
  "Order of Glinting Steel": {
    ...
    talents: {
	  ...
	  "Predominance": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`You take 15% less damage against enemies with Inevitable, Unstoppable`,
      },
	  "Improved Distract": {
        name: "Improved Distract",
        pos: "h6",
  ...
  "Order of the Blazing Sun": {
    ...
    talents: {
	  ...
	  "Blazing Blade": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Applies an ailment to target enemy for 9 seconds. For the duration, target takes X% MAP + Y elemental damage every 3 seconds.`,
      },
	  "Smash": {
        name: "Smash",
        pos: "g1",
	  ...
	  "Judgement Blade": {
        ...
        cast: "3.0s channel",
        cooldown: "no cooldown",
        description: talentText`Deals X% MAP + Y elemental damage per second to target enemy. This damage is increased by 50% per active Command you have.`,
      },
	  "Into the Breach!": {
