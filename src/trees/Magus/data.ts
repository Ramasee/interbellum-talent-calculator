  ...
  "Poxbringer": {
    ...
    talents: {
      ...
      "Nurgle's Visitation": {
        ...
        description: talentText`Deals 4% SAP + 54 corporeal damage to target enemy. Will attack the target again for each stack of Pestilent Growth, Spore Diffusion, Withered Soul, Speckled Hide, and Seed of Chaos on the target. Up to a maximum of 10 hits.\n\nNurgle Fanatacism: instead, will restore 50% RP + 250 health to the target and caster applying 10 stacks of Nurgle Corruption to both.`,
      },
      "The Great Plague": {
	  ...
	  "Sacred Number of Nurgle": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Whenever Pestilent Growth, Spore Diffusion, Withered Soul, or Speckled Hide deal damage, you will gain a stack of Nurgle's Favor. Whenever you reach 8 stacks, they will be dispelled and you will lose ${[
          4,
          8,
          12,
          16,
