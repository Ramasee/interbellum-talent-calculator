  ...
  "Bladesinger": {
    ...
    talents: {
      ...
      "Weapon Aptitude": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Bladesingers dual wield swords.`,
      },
      "Hunter's Trap": {
        name: "Hunter's Trap",
        pos: "i4",
	  ...
	  "Brush Off": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`While under the effect of Pain for Pleasure, restore 120 + 8% wounds health every second.`,
      },
	  "Chaotic Populist": {
        name: "Chaotic Populist",
        pos: "b6",
	  ...
	  "Decadent Apostles": {
        name: "Decadent Apostles",
        pos: "a7",
        icon: icons["tac_spec_5"],
        maxRank: 1,
        reqPoints: 20,
        type: "career tactic",
        description: talentText`Duration of Sleepy that you apply is increased by 2 seconds.`,
      },
	  "Insane Whispers": {
        ...
        reqPoints: 20,
        type: "career tactic",
        description: talentText`You lose 10000 potency. Whenever you critically hit an enemy, you will apply a 5 second affliction to them. For the duration, their outgoing damage is decreased by 15%.`,
      },
	  "Euphoric Dominance": {
        name: "Euphoric Dominance",
        pos: "f8",
        icon: icons["tac_spec_3"],
        maxRank: 1,
        reqPoints: 25,
        type: "career tactic",
        description: talentText`Abilities cast in Gift of Savagery and Gift of Plague have a 50% chance to apply a stack of Pride to the target.`,
      },
	  "Harvester of Souls": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`While in Gift of Pride, you will lose 1 Khorne Corruption every 2 seconds. When corruption is removed this way, you will gain ${[
          25,
          50,
        ]}% critical chance for 2 seconds.`,
      },
	  "Hold the Line": {
        name: "Hold the Line",
        pos: "c4",
	  ...
	  "Unstable Convulsions": {
        ...
        reqPoints: 10,
        type: "passive",
        description: talentText`While in Gift of Pride, you gain ${[
          1,
          2,
          3,
          4,
          5,
        ]}% accuracy.\nWhile in Gift of Plague, you gain ${[
          3,
          6,
          9,
          12,
          15,
        ]}% block chance.\nWhile in Gift of Savagery, you gain ${[
          2,
          4,
          6,
          8,
	  ...
	  "Improved Flail": {
        ...
        reqPoints: 20,
        type: "passive",
        description: talentText`Flail has a ${[
          15,
          30,
          50,
        ]}% chance to strike a third time.`,
      },
