  ...
  "Khorne": {
    ...
    talents: {
	  ...
	  "Wrecking Ball": {
        ...
        maxRank: 1,
        reqPoints: 25,
        prereq: "Widespread Demolition",
		arrows: [
          { dir: "down", from: "g7", to: "g8" },
        ],
        type: "skill",
        cost: "50 action points",
        range: "self",
	  ...
	  "Admire the Corrupt": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`Impale will hit 2 additional enemies within 15 feet for 33% of its damage per stack of Blood-marked on the target.`,
      },
	  "Growing Instability": {
	  ...
	  "Unrelenting Conflict": {
        ...
        reqPoints: 25,
        type: "career tactic",
        description: talentText`Abilities cast in Gift of Pride and Gift of Nurgle have a 50% chance to apply a stack of Savagery to the target.`,
      },
	  "Forked Aggression": {
  ...
  "Nurgle": {
    ...
    talents: {
      ...
      "Specialization Mechanic": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Nurgle Marauders dual wield hammers.`,
      },
      "Core Ability 1": {
        name: "Core Ability 1",
        pos: "b1",
