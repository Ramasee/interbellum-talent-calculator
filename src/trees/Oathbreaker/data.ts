  ...
  "Brother of Grimnir": {
    ...
    talents: {
      ...
      "Ability 4": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 30 Rage",
        description: talentText`Apply a 5 second enchantment to target ally. For the duration, they will absorb up to X% RP + Y damage. Also apply a 5 second blessing to target ally. For the duration, they gain toughness equal to 50% of your toughness.`,
      },
      "Anklecrusher": {
        name: "Anklecrusher",
        pos: "f1",
  ...
  "Giantslayer": {
    ...
    talents: {
	  ...
	  "Ability 1": {
        ...
        cooldown: "no cooldown",
        blue: "Costs Bloodthirst",
        description: talentText`Applies a 9 second affliction to target enemy stacking up to 3 times.. Every 3 seconds, the target takes X% MAP + Y ichor damage. (66%)`,
      },
	  "Wild Swing": {
        name: "Wild Swing",
        pos: "g6",
	  ...
	  "Ability 2": {
        ...
        cooldown: "no cooldown",
        blue: "Costs 30 Rage",
        description: talentText`Applies a 6 second affliction on target enemy. Deals X% MAP + Y ichor damage to them at the end of the duration and generates 1 Bloodthirst for you.`,
      },
      "Capstone Passive 2": {
	  ...
	  "Tactic 3": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`Cave-In will generate 1 Bloodthirst and deal X% MAP + Y impact damage. (25ap)`,
      },
	  "Tactic 1": {
        name: "Tactic 1",
        pos: "f6",
