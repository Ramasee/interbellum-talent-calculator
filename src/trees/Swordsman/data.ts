  ...
  "Free Company": {
    ...
    talents: {
	  ...
	  "Razor Strike": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Deals 10% MAP + 126 piercing damage to up to 9 enemies within 30 feet in front of you. You will generate a Combo Point on each target hit.`,
      },
      ...
      "Rupture": {
        ...
        cooldown: "no cooldown",
        blue: "Execute",
        description: talentText`Applies a 21 second debuff to target enemy, which can stack up to 3 times. For the duration, target takes 25% MAP + 330 ichor damage every 3 seconds.`,
      },
      "Whirlwind": {
        name: "Whirlwind",
        pos: "f9",
	  ...
	  "Fervent Fury": {
        ...
        reqPoints: 10,
        type: "career tactic",
        description: talentText`Fervor now applies a cripple which deals its damage and applies 1 Combo Point to the target every 5 seconds.`,
      },
	  "Encourage Confession": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`Whenever you hit an enemy with an Execute, you will apply 2 stacks of Reduced Block and 3 stacks of Purity to them.`,
      },
	  "Blood, Faith, and Fire": {
        ...
        reqPoints: 15,
        type: "career tactic",
        description: talentText`Burn at the Stake, Fervor, and Rupture can now critically hit.`,
      },
	  "Sweeping Razor": {
        name: "Sweeping Razor",
        pos: "a7",
        ...
        reqPoints: 20,
        type: "career tactic",
        description: talentText`Razor Strike, Spread Shot, and Trial by Pain can now hit up to 24 enemies.`,
      },
	  ...
	  "Seal Master": {
        ...
        reqPoints: 25,
        type: "career tactic",
        description: talentText`Seal of Van Horstman and Seal of Wilhelm no longer have negative effects and have a 20 second cooldown.`,
      },
	  "State-Issued Weapons": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Whenever you use an Execute, your next ${[
          1,
          2,
          3,
          4,
          5,
        ]} abilities will deal an additional 6% MAP + 80 piercing damage.`,
      },
	  "Improved Vigilance": {
        name: "blueprint",
        pos: "e5",
	  ...
	  "Efficient Strikes": {
        ...
        reqPoints: 15,
        type: "passive",
        description: talentText`Your basic attack has a ${[
          20,
          40,
        ]}% chance to generate 1 Combo Point on the target.`,
      },
	  "Extra Crit": {
        name: "Extra Crit",
        pos: "d6",
	  ...
	  "Protection From Heresy": {
        ...
        pos: "d7",
        icon: icons["abi_em_sigilofsigmar"],
        maxRank: 3,
        reqPoints: 20,
        type: "passive",
        description: talentText`Whenever you us Seal of Wilhelm or Seal of Van Horstman, you will gain ${[
          1,
          2,
          3,
          4,
          5,
        ]} stacks of a buff for 10 seconds. Each stack grants +20% dodge and is dispelled whenever you dodge.`,
      },
	  "Pain Unleashed": {
        name: "Pain Unleashed",
        pos: "h7",
	  ...
	  "Emperor's Finest": {
        ...
        pos: "f8",
        icon: icons["abi_em_seekersblade"],
        maxRank: 4,
        reqPoints: 25,
        type: "passive",
        description: talentText`Whenever you critically hit an enemy, you will apply a 3 second ailment to them which cannot refresh. At the end of the duration, you will deal ${[
          "40 + 6",
          "80 + 12",
          "120 + 18",
          "160 + 24",
  ...
  "Witch Hunter": {
    ...
    talents: {
	  ...
	  "Superior Steel": {
        ...
        reqPoints: 10,
        type: "passive",
        description: talentText`The second hit of Steel and Gunpowder deals ${[
          100,
          200,
		  300,
        ]}% additional damage.`,
      ...
      "Sanctified Oils": {
        ...
        reqPoints: 25,
        type: "passive",
        description: talentText`Your attacks deal additional elemental damage equal to ${[
          5,
		  10,
          15,
		  20,
  ...
  "Outrider": {
    ...
    talents: {
      ...
      "Battle Steed": {
        ...
        blue: "Castable While Moving",
        description: talentText`Toggle: While active, gain 20% movement speed and 1.5s faster cast times, but lose 40% accuracy.`,
      },
      "Fervor": {
        name: "Fervor",
        pos: "f1",
	  ...
	  "Barbed Strike": {
        ...
        reqPoints: 10,
        type: "career tactic",
        description: talentText`If you are within 8 feet of your target, Steel and Gunpowder applies Ensnared and Momentum to your target. It also applies a 15% movement speed increase to the caster for 5 seconds.`,
      },
	  "Encourage Confession": {
        name: "Encourage Confession",
        pos: "b6",
	  ...
	  "Pistolkorps": {
        ...
        reqPoints: 10,
        type: "passive",
        description: talentText`Steel and Gunpowder generates ${[
          5,
          10,
          15,
        ]} more action points.`,
	  ...
	  "Blinkers": {
        ...
        reqPoints: 15,
        type: "passive",
        description: talentText`Battle Steed now increases movement speed by ${[
          22,
          24,
          26,
          28,
          30,
        ]}% and the accuracy penalty is now ${[
          37,
          34,
          31,
          28,
	  ...
	  "Mercury Tips": {
        ...
        type: "passive",
        description: talentText`Quick Shot now deals ${[
          6,
          12,
          18,
          ...
          66,
          100,
        ]}% chance to apply 1 stack of Reduced Hardiness to the target.`,
      },
	  "Rifled Barrels": {
        name: "Rifled Barrels",
        pos: "e7",
        ...
        description: talentText`You gain ${[
          ...
          6,
          9,
        ]}% outgoing damage. This bonus is lost while on Battle Steed.`,
      },
	  "Suppresive Fire": {
        ...
        reqPoints: 25,
        type: "passive",
        description: talentText`Each time you hit an enemy, they will lose 1% dodge and 1% movement speed for 2 seconds. This effect stacks up to ${[
          2,
          6,
          12,
          20,
