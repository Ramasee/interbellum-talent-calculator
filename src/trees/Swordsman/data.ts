  ...
  "Free Company": {
    ...
    talents: {
	  ...
	  "Fervor": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Applies a 21 second ailment and 1 Combo Point to target enemy. For the duratiom, target takes X% MAP + Y ichor damage every 3 seconds.`,
      },    
      "Bind Weapon": {
        name: "Bind Weapon",
        pos: "g1",
      ...
      "Rupture": {
        ...
        cooldown: "no cooldown",
        blue: "Execute",
        description: talentText`Applies a 21 second debuff to target enemy, which can stack up to 3 times. For the duration, target takes X% MAP + Y ichor damage every 3 seconds.`,
      },
      "Whirlwind": {
        name: "Whirlwind",
        pos: "f9",
