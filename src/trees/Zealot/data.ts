  ...
  "Tzeentch": {
    ...
    talents: {
      ...
      "Weapon Aptitude": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Tzeentch Zealots equip ritual daggers and fetishes.`,
      },
      "Changer's Touch": {
      ...
      "Flash of Chaos": {
        ...
        cast: "instant cast",
        cooldown: "no cooldown",
        description: talentText`Heals target ally for 55. Applies 1 stack of Tzeentch Corruption to caster.`,
      },
      "Warp Reality": {
        name: "Warp Reality",
        pos: "c1",
	  ...
	  "Vaulting Alterations": {
        ...
        type: "career tactic",
        description: talentText`Leaping Alteration will heal a 3rd ally within 20 feet of the target.`,
      },
	  "Daemonic Fortitude": {
	  ...
	  "Improved Flash of Chaos": {
        ...
        reqPoints: 5,
        type: "passive",
        description: talentText`Flash of Chaos will restore additional health equal to ${[
          3,
          6,
          9,
          12,
	  ...
	  "Blood in Mouth": {
        ...
        description: talentText`Each time you take damage from Blood Sacrifice, you have a ${[
          ...
          75,
          100,
        ]}% chance to restore 6% wounds + 90 health to a groupmate within 100 feet of you.`,
      },
    },
  },
  "Slaanesh": {
    ...
    talents: {
      ...
      "Weapon Aptitude": {
        ...
        reqPoints: 0,
        type: "passive",
        description: talentText`Slaanesh Zealots equip one-handed swords and shields.`,
      },
      "Morale 1 Class": {
        name: "Morale 1 Class",
        pos: "i4",
